...
​
    ...
    utterances = [pd.read_csv(os.path.join(utterance_folder, f), sep='\t', skiprows=6) for f in utterance_files]
​
    for i, utterance in enumerate(utterances):
        ...
        left, top, right, bot = compute_increased_bbox([left, top, right, bot], increase_area=args.increase)
        left = max(left, 0)
        top = max(top, 0)
        ...
        chunk_name = os.path.join(args.chunk_folder, f'{person_id}_{video_id}_{i}.mp4')
...
​
    parser.add_argument("--annotations_folder", default='/home/seoh/vox2_txt', help='Path to utterance annotations')
    parser.add_argument("--video_folder", default='/home/seoh/vox2_raw', help='Path to intermediate videos')
    parser.add_argument("--chunk_folder", default='/home/seoh/vox2_processed', help="Path to folder with video chunks")
​
​
